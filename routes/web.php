...
Route::group(['prefix' => 'admin'], function () {
  // Role
  Route::get('role', [MainController::class, 'role'])->name('role.index');
  Route::post('role-create', [MainController::class, 'RoleCreate'])->name('role.create');
  // Role End
  // Role
  Route::get('members', [MainController::class, 'members'])->name('members.index');
  Route::get('member_register', [MainController::class, 'member_register'])->name('members.register');
  Route::get('pay-fee', [MainController::class, 'member_register'])->name('members.payfee');
  Route::post('members-create', [MainController::class, 'MemberCreate'])->name('members.create');
  // Role End
  Route::get('membership', [MainController::class, 'membership'])->name('membership.index');
  Route::post('membership-add', [MainController::class, 'MembershipAdd'])->name('membership.add');
  Route::post('membership-edit', [MainController::class, 'EditMembershipForm'])->name('edit.membership.form');
  Route::post('membership-delete', [MainController::class, 'DeleteMembershipForm'])->name('delete.membership');
  Route::post('membership-create', [MainController::class, 'MembershipCreate'])->name('membership.create');
  Route::post('membership-amount', [MainController::class, 'MembershipAmount'])->name('membership.amount');
  Route::get('MemberPaymentDtl/{id}', [MainController::class, 'MemberPaymentDtl'])->name('MemberPaymentDtl');
});
